...
# ============================================================
# 3. 工具函数：评估模型（Train/Test + 5-fold CV + LOOCV-RMSE）
# ============================================================

def evaluate_model(model, X_train, X_test, y_train, y_test):
    """给定已经准备好的 X_train/X_test 和 y，拟合并返回各种指标。"""
    # 拟合
...
for target in SELF_TARGETS:
    ...
    try:
        scores = evaluate_model(enet, X_train, X_test, y_train, y_test)
    ...
    try:
        ...
        scores = evaluate_model(best_xgb, X_train, X_test, y_train, y_test)
    ...
    try:
        ...
        scores = evaluate_model(best_svr, X_train, X_test, y_train, y_test)
    ...
    # 这里的 scoring 改为 neg_mean_squared_error，更关注整体误差而不是盲目拉高 R²
    ...
    try:
        ...
        scores = evaluate_model(best_mlp, X_train, X_test, y_train, y_test)
